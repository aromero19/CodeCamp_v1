...
class ChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post checks_url, params: { check: { answer: @check.answer, comments: @check.comments, description: @check.description } }
    end
  ...
  test "should update check" do
    patch check_url(@check), params: { check: { answer: @check.answer, comments: @check.comments, description: @check.description } }
