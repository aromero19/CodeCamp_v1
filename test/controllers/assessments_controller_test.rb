...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { answer_id: @assessment.answer_id, description: @assessment.description, question_id: @assessment.question_id } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { answer_id: @assessment.answer_id, description: @assessment.description, question_id: @assessment.question_id } }
